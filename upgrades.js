...
// var stock = newupgrade("Go Public", "1,000 Bananas | Your banana company is now public! Anyone can buy and sell stock shares on the market. | +10 bpc", 1000, "assets/paper.png", "addtobpc(10)") Sadly, this won't work with the new bpc system :(
...
var monkeycult = newupgrade("Monkey Cult", "8,000 Bananas | A cult of loyal monkeys to convice others to buy your bananas; In a perfectly legal matter of course 😊 | x2 Monkey Production", 8000, "assets/monkey.png", "yield_monkey = yield_monkey * 2")
var monkeypoop = newupgrade("Monkey Poop", "20,000 Bananas | Juicy monkey poo to improve your fertilizer💩 | x2 Fertilizer Production", 20000, "assets/magikgrow.png", "yield_magikgrow = yield_magikgrow * 2")
var bettermagikgrow = newupgrade("Improved Fertilizer", "50,000 Bananas | Higher quality fertilizer that's better than magic | x3 Fertilizer Production", 50000, "assets/magikgrow.png", "yield_magikgrow = 20 * 3")
